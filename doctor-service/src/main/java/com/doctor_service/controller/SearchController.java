...
public class SearchController {
    ...
    // Example:
    // http://localhost:8080/v1/v1/doctor/search?specialization=cardiologist&areaName=btm
    @GetMapping("/search")
   ...
   // http://localhost:8080/v1/v1/doctor/getdoctorbyid?id=1
